...
def test_test_database_creation():
    ...
    FileSystem.pushd(current_directory, 'django', 'jilo')

    status, out = commands.getstatusoutput("python manage.py harvest --test-database --apps=fruits")
